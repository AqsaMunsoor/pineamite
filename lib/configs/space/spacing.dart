...
class Space {
  ...
  /// Expanded SizedBox with infinite width
  static const Widget xm = Expanded(child: SizedBox(width: double.infinity));

  /// Expanded SizedBox with infinite height
  static const Widget ym = Expanded(child: SizedBox(height: double.infinity));

  static const Widget bottom = _BottomSafeAreaSpace();
}
...
class _V {
  ...
  SizedBox get t25 => const SizedBox(height: 25);
...
class _VerticalPadding {
  ...
  EdgeInsets get t25 => const EdgeInsets.symmetric(vertical: 25);
}

class _HorizontalPadding {
  EdgeInsets get t04 => const EdgeInsets.symmetric(horizontal: 04);
  EdgeInsets get t08 => const EdgeInsets.symmetric(horizontal: 08);
  ...
  EdgeInsets get t25 => const EdgeInsets.symmetric(horizontal: 25);
  EdgeInsets get t30 => const EdgeInsets.symmetric(horizontal: 30);
}

class _TopPadding {
  EdgeInsets get t04 => const EdgeInsets.only(top: 4);
  EdgeInsets get t08 => const EdgeInsets.only(top: 8);
  EdgeInsets get t15 => const EdgeInsets.only(top: 15);
}

class _BottomPadding {
  EdgeInsets get t05 => const EdgeInsets.only(bottom: 5);
...
class _AllPadding {
  ...
  EdgeInsets get t15 => const EdgeInsets.all(15);
  EdgeInsets get t20 => const EdgeInsets.all(20);
  EdgeInsets get t25 => const EdgeInsets.all(25);
}
...
class _BottomSafeAreaSpace extends StatelessWidget {
  const _BottomSafeAreaSpace();
