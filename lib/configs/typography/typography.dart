...
class AppTextStyle extends TextStyle {
  const AppTextStyle({
    ...
    String fontFamily = FontFamily.kuunari,
  ...
  AppTextStyle copyWith({
    ...
    return AppTextStyle(
      ...
      fontFamily: fontFamily ?? this.fontFamily ?? FontFamily.kuunari,
    );
  }
  ...
  AppTextStyle operator +(dynamic other) {
    ...
    } else if (other is TextDecoration) {
      return copyWith(decoration: other, decorationColor: color);
